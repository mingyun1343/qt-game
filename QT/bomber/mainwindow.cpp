...
//        QLabel *role2=new QLabel;
//        role2->setPixmap(QPixmap(":/images/woman.png"));
//        role2->resize(200,250);
//        role2->move(475,125);
//        role2->setParent(set);
...
//        role_radio2->setParent(set);
//        role_radio2->move(550,400);
//        connect(role_radio2,&QRadioButton::clicked,this,[=](){
//            role=1;
//        });
